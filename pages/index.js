...
export default function Home() {
  ...
  function renderCreateProposalTab() {
    if (loading) {
      ...
      return (
        <div className={styles.description}>
          You do not own any Web3Devs NFTs. <br />
    ...
    <div>
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>Welcome to the Code DAO!</div>
          <div className={styles.description}>
            Your Web3Devs NFT Balance: {nftBalance}
            <br />
      ...
      <footer className={styles.footer}>Made with &#10084; by Web3 Devs</footer>
    </div>
  );
}
